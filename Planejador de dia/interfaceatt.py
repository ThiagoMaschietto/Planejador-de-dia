...
def gui_att(data):
    ...
    texto1.insert(1.0,mongodb.recupera_dados(data,"01:00"))
    ...
    texto2.insert(1.0,mongodb.recupera_dados(data,"02:00"))
    ...
    texto3.insert(1.0,mongodb.recupera_dados(data,"03:00"))
    ...
    texto4.insert(1.0,mongodb.recupera_dados(data,"04:00"))
    ...
    texto5.insert(1.0,mongodb.recupera_dados(data,"05:00"))
    ...
    texto6.insert(1.0,mongodb.recupera_dados(data,"06:00"))
    ...
    texto7.insert(1.0,mongodb.recupera_dados(data,"07:00"))
    ...
    texto8.insert(1.0,mongodb.recupera_dados(data,"08:00"))
    ...
    texto9.insert(1.0,mongodb.recupera_dados(data,"09:00"))
    ...
    texto10.insert(1.0,mongodb.recupera_dados(data,"10:00"))
    ...
    texto11.insert(1.0,mongodb.recupera_dados(data,"11:00"))
    ...
    texto12.insert(1.0,mongodb.recupera_dados(data,"12:00"))
    ...
    texto13.insert(1.0,mongodb.recupera_dados(data,"13:00"))
    ...
    texto14.insert(1.0,mongodb.recupera_dados(data,"14:00"))
    ...
    texto15.insert(1.0,mongodb.recupera_dados(data,"15:00"))
    ...
    texto16.insert(1.0,mongodb.recupera_dados(data,"16:00"))
    ...
    texto17.insert(1.0,mongodb.recupera_dados(data,"17:00"))
    ...
    texto18.insert(1.0,mongodb.recupera_dados(data,"18:00"))
    ...
    texto19.insert(1.0,mongodb.recupera_dados(data,"19:00"))
    ...
    texto20.insert(1.0,mongodb.recupera_dados(data,"20:00"))
    ...
    texto21.insert(1.0,mongodb.recupera_dados(data,"21:00"))
    ...
    texto22.insert(1.0,mongodb.recupera_dados(data,"22:00"))
    ...
    texto23.insert(1.0,mongodb.recupera_dados(data,"23:00"))
    ...
    texto24.insert(1.0,mongodb.recupera_dados(data,"24:00"))
    ...
    botao_salvar = CTkButton(janela, text = "Salvar Mundanças", command = lambda: get_text(
        ...
        texto22,texto23,texto24,data,True))
